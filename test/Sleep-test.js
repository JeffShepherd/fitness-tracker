...
describe('Sleep', () => {
  ...
  it('should return a user\'s sleep data for last seven days', function () {
  ...
  it('should return all time sleep quality average for all users', function () {
    expect(testSleep.getAverageSleepQualityForAll()).to.equal(6);
  });
